    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="heading">
             <div class="responsive-video"><iframe width="560" height="315" src="//www.youtube.com/embed/uUx3_0vvVA4" frameborder="0" allowfullscreen></iframe></div>
          </div>
        </div>
      </div>
      <hr>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="col-lg-2">
            <img src="/images/sharktank.jpg" alt="shark tank" class="img-rounded">
          </div>
          <div class="col-lg-10">
            <h2>Shark Tank</h2>
